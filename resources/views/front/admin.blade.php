...
<body>
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><span>{{Auth::guard('admin')->user()->name}}</span>Admin</a>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="active"><a href="admin/index.html"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
			...
			<li><a href="admin/login.html"><em class="fa fa-power-off">&nbsp;</em> Logout</a></li>
		</ul>
	</div><!--/.sidebar-->
