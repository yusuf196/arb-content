		...
		<div class="col-md-9">
			...
			<div class="page-content ask-question">
				...
				<div class="form-style form-style-3" id="question-submit">
					<form action="/updatePost/{{$post->id}}" method="post" value="{{ csrf_token() }} "enctype="multipart/form-data">
						{{ csrf_field() }}
						<div class="form-group">

							<p>
								<label class="required">عنوان المقالة<span>*</span></label>
								<input type="text" id="question-title" placeholder="{{$post->title}}"  name="title" class="form-control" value="{{$post->title}}">
						...
						<div id="form-textarea">
							<p>
								...
								<div id="respond" class="comment-respond page-content clearfix">
                                                ...
                                                <textarea id="article-ckeditor" name="body" aria-required="true"   cols="58" rows="8">{!!$post->desc_post !!}</textarea>
						...
						<p class="form-submit">
							...
							<input type="submit" id="publish-question" value="تعديل المقالة " class="button color small submit">
						</p>
					</form>
				</div>
