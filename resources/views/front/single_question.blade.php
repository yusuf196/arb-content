			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="crumbs">
						...
						<a href="#">الاسئلة</a>
						<span class="crumbs-span">/</span>
						<span class="current">هذا هو سؤالي الأول</span>
					</div>
				</div>
			</div><!-- End row -->
			...
			<div class="col-md-9">
				...
				<div id="related-posts">
					...
					<ul class="related-posts">
						<li class="related-item"><h3><a href="#"><i class="icon-double-angle-right"></i>هذا هو سؤال الاستطلاع الثاني</a></h3></li>
						<li class="related-item"><h3><a href="#"><i class="icon-double-angle-right"></i>هذا هو سؤالي الثالث</a></h3></li>
						<li class="related-item"><h3><a href="#"><i class="icon-double-angle-right"></i>هذا هو سؤالي الرابع</a></h3></li>
						<li class="related-item"><h3><a href="#"><i class="icon-double-angle-right"></i>هذا هو سؤالي الخامس</a></h3></li>
					</ul>
					    ...
					    <li class="comment">
					        <div class="comment-body comment-body-answered clearfix"> 
					            ...
					            <div class="comment-text">
					                ...
					                <div class="text"><p>هناك حقيقة مثبتة منذ زمن طويل وهي أن المحتوى المقروء لصفحة ما سيلهي القارئ عن التركيز على الشكل الخارجي للنص أو شكل توضع الفقرات في الصفحة التي يقرأها. </p>
					                </div>
									<div class="question-answered question-answered-done"><i class="icon-ok"></i>أفضل إجابة</div>
					            </div>
					        </div>
					        <ul class="children">
					            <li class="comment">
