					...
					<div class="page-content">
						...
						<form class="form-style form-style-3 form-style-5 form-js" action="contact_us.php" method="post">
							<div class="form-inputs clearfix">
								...
								<p>
									<label for="mail" class="required">الإيميل<span>*</span></label>
									<input type="email" class="required-item" id="mail" name="mail" value="" aria-required="true">
								</p>
								<p>
									<label for="url" class="required">الموقع</label>
									<input type="text" id="url" name="url" value="">
								</p>
							</div>
							<div class="form-textarea">
								<p>
									<label for="message" class="required">الرسالة<span>*</span></label>
									<textarea id="message" class="required-item" name="message" aria-required="true" cols="58" rows="7"></textarea>
								</p>
							</div>
							<p class="form-submit">
								<input name="submit" type="submit" value="إرسال" class="submit button small color">
							</p>
						</form>
					</div><!-- End page-content -->
				</div><!-- End col-md-6 -->
